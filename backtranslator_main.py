# Backtranslates a dataset.
#
# Usage example:
#
#    python backtranslator_main.py --in src_data/small_amazon_reviews_digital_music.json --out /tmp/test_bt.json --field  "reviewText"
#
...
def main():
  ...
  backtranslator = BackTranslator(use_actual)

  # Parse.
  df = dataset_io.to_df(args.input)
  new_df = backtranslator.augment_df(df, args.field)
